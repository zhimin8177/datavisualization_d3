...
var line_color_6 = 'black'
var background_color_6 = '#EEEBD7'
var mouse_color_6 = 'blue'
var bar_opacity_6 = 0.7
...
var svg_6 = d3.select("#container_6")
  ...
  .attr("style", "border:1px solid blue")
  .style("background-color", background_color_6)
  .append("g")
...
d3.csv("data/prize_pub_year_all.csv").then(function (dataset) {
  // 把数据转成数值形式
  ...
  var bars_6 = svg_6
    ...
    .attr("opacity", bar_opacity_6);

  // 添加鼠标悬停事件处理程序
  bars_6
    .on("mouseover", function (event, d) {
      var paperCount = d.paper_count;
      var prizeYear = d.prize_pub_year;
      ...
      // 将当前柱子设置为悬停状态的样式
      d3.select(this).style("fill", mouse_color_6);

      // 在页面上显示信息
      var tooltip = d3.select("#tooltip");
      tooltip
        .text("Prize Year: " + prizeYear + ", Paper Count: " + paperCount)
...
//   }
  ...
  .attr("class", "axis-label")
  .attr("x", WIDTH_6 / 2)
  .attr("y", HEIGHT_6 + MARGIN_6.bottom)
  .attr("dy", "1em")
  .style("text-anchor", "middle")
  .text("发表年份和获奖年份之间的差距");
